        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Bitmap yourBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.dp);
        Bitmap blurred = BlurImageView.blurRenderScript(this,yourBitmap, 25);
